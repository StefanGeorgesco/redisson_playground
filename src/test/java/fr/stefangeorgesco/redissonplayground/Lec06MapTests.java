...
class Lec06MapTests extends BaseTests {
    ...
    void mapTestPutStringString() {
        RMapReactive<String, String> stringStringRMap = client.getMap("user:1", StringCodec.INSTANCE);
    ...
    void mapTestPutAllStringString() {
        RMapReactive<String, String> stringStringRMap = client.getMap("user:2", StringCodec.INSTANCE);
